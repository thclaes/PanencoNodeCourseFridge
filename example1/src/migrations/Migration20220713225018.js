...
class Migration20220713225018 extends Migration {

  async up() {
    this.addSql('create table "recipe" ("id" uuid not null, "name" varchar(255) null, "description" varchar(255) null, "size" int null, "owner_id" uuid not null);');
    ...
    this.addSql('create table "product" ("id" uuid not null, "type" varchar(255) null, "name" varchar(255) null, "size" int null, "fridge_id" uuid not null, "owner_id" uuid not null);');
...
exports.Migration20220713225018 = Migration20220713225018;
